export const environment = {
  ...
  apiBaseUrl: process.env.NEXT_PUBLIC_API_BASE_URL || "https://prompt-killer.onrender.com/",
  apiDefaultTimeout: 1,
  applicationName: "Prompt Killer",
  companyCode: "123", // update with your company code
  ExternalIntegrations: {
    Google: {
      clientIdForWeb: "189252447120-j52to7iveehh7sjcqsb3d1erishap5bb.apps.googleusercontent.com",
