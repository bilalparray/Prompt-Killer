...
export default function CategoryEditPromptPage() {
  ...
  const loadCategory = async () => {
    try {
      ...
      if (response.successData) setCategory(response.successData);
    } catch (e) {
      ...
      if (response.successData) {
        ...
        if (prompt.categoryId !== categoryId) {
          await commonService.showSweetAlertToast({
            ...
            text: "This prompt belongs to another category. Redirecting.",
          });
          router.push(`/admin/categories/${prompt.categoryId}/prompts`);
          return;
        }
  ...
  const onSubmit = async (data: PromptFormData) => {
    ...
    try {
      ...
      prompt.id = promptId;
      prompt.categoryId = loadedPrompt.categoryId;
  ...
  const backUrl = `/admin/categories/${categoryId}/prompts`;
            ...
            <div className="col-12">
              <nav aria-label="breadcrumb">
                <ol className="breadcrumb mb-2">
                  ...
                  <li className="breadcrumb-item">
                    <Link href={backUrl}>{categoryName} – Prompts</Link>
                  </li>
              ...
              <div className="d-flex justify-content-between align-items-center mb-3">
                <div>
                  ...
                  <p className="text-muted mb-0">Update prompt in &quot;{categoryName}&quot;</p>
                </div>
                <Link href={backUrl} className="btn btn-outline-secondary rounded-pill px-4">
                      ...
                      {loadedPrompt && (
                        <div className="col-12">
                          <div className="alert alert-info border-0" style={{ borderRadius: "12px" }}>
                            ...
                            <strong>{loadedPrompt.samples?.length || 0}</strong> sample(s). They will be preserved.
                          </div>
                        </div>
                      )}
                    </div>
